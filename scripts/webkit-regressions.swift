...
guard CommandLine.arguments.count == 2,
      ...
      ["/harness/diagnostics.html", "/harness/conflicts.html", "/harness/uncommitted.html", "/harness/coverage.html", "/harness/blame.html", "/harness/branches.html", "/harness/hygiene.html", "/harness/palette.html", "/harness/status.html", "/harness/tasks.html", "/harness/task-materials.html", "/harness/task-runs.html", "/harness/onboarding.html", "/harness/firebase.html", "/harness/delivery.html", "/harness/terminal.html", "/harness/impact.html"].contains(url.path) else {
