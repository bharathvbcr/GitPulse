...
flowchart TB
    ...
    subgraph IPC["Tauri 2 IPC Seam (snake_case ↔ camelCase)"]
        ...
        ContractCheck["241 Handlers Enforced by <code>check:ipc</code>"]
        Invoke -.-> ContractCheck
    end

    subgraph Backend["Rust Backend (Tauri 2 / Rayon)"]
        direction TB
        CmdRegistry["Command Registry (241 Handlers)<br/><code>src-tauri/src/commands/</code>"]
