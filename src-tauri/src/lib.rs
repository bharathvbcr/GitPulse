...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            cmd_take_pending_open,
            cmd_set_recent_menu,
            desktop::cmd_set_menu_state,
            desktop::popover::cmd_get_status_state,
            desktop::popover::cmd_status_action,
            desktop::popover::cmd_resize_status,
            cmd_resolve_git_root,
            cmd_open_worktree_path,
            cmd_reveal_worktree_path,
            desktop::shell::cmd_reveal_repository,
            ...
            cmd_catch_up,
            cmd_grants_view,
            cmd_provenance_freshness,
            cmd_provenance_freshness_batch,
            cmd_local_scan,
