...
<footer
  title={forcedTip}
  class="gp-glass h-6 shrink-0 bg-surface border-t border-border/70 gp-section-edge px-3 flex items-center justify-between text-[11px] font-sans text-textMuted select-none z-20"
  role="status"
